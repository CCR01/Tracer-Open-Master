...
real32_T rtNaNF_psf;
extern void rt_InitInfAndNaN_psf(size_t realSize);
extern boolean_T rtIsInf_psf(real_T value);
extern boolean_T rtIsInfF_psf(real32_T value);
extern boolean_T rtIsNaN_psf(real_T value);
extern boolean_T rtIsNaNF_psf(real32_T value);
//end of that
...
extern omp_nest_lock_t emlrtNestLockGlobal_psf;
...
extern void emxEnsureCapacity_int32_T_psf(emxArray_int32_T *emxArray, int oldNumel);
...
extern void emxFree_int32_T_psf(emxArray_int32_T **pEmxArray);
...
extern void emxInit_int32_T_psf(emxArray_int32_T **pEmxArray, int numDimensions);
