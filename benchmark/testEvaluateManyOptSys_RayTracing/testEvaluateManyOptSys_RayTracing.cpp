#include "testEvaluateManyOptSys_RayTracing.h"
...
testEvaluateManyOptSys_RayTracing::testEvaluateManyOptSys_RayTracing(){}

testEvaluateManyOptSys_RayTracing::~testEvaluateManyOptSys_RayTracing() {}


bool testEvaluateManyOptSys_RayTracing::testEvaManyOptSys_RayTracing_SuperFct()
{
	std::vector<bool> workTestEva_RT_SF;

	// check E0
	bool checkE0 = testEvaManyOptSys_RT_E0();
	workTestEva_RT_SF.push_back(checkE0);

	// TODO wirte more checks!

	bool checker = Math::checkTrueOfVectorElements(workTestEva_RT_SF);
	return checker;
}

bool testEvaluateManyOptSys_RayTracing::testEvaManyOptSys_RT_E0()
{
	std::vector<bool> workTestEva_RT_E0;
	...
	EvaluateManyOptSys_RayTracing calcCombVec_E0(/*optical System Element*/ optSystemElement_E0, /* add infos*/ addInfosVariable, /*fields*/fields, /*wavelenghts*/ wavelengths);
	...
	real excelBest_Zemax_RMS = 312.523;
	bool checkE0_rmsBest = Math::compareTwoNumbers_decimals(excelBest_Zemax_RMS, rmsSpotE0, 2);
	workTestEva_RT_E0.push_back(checkE0_rmsBest);
	
	
	bool returnCheckerE0 = Math::checkTrueOfVectorElements(workTestEva_RT_E0);
