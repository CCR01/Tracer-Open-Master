...
bool BenchmarkRayAiming::checkRayAimingSuperFct_inf()
{
...
bool BenchmarkRayAiming::checkRayAimingSuperFct_obj()
{
...
bool BenchmarkRayAiming::checkRayAimingE0_obj()
{
	...
	lightRay_interPoint_onTarget ch00_obj_0 = checkRayAimingSingleRay_obj(/*opt sys LLT*/ TestSystem00, /*ray origin*/ originTS0_0, /*target point*/ targetPointTS0_0, /*light*/ light, /*accurency*/  0.00001);
	checkRayAiming_E0.push_back(ch00_obj_0.getOnTarget());
	
	VectorStructR3 targetPointTS0_1 = { -0.6 ,-0.5,20.0 };
	lightRay_interPoint_onTarget ch00_obj_1 = checkRayAimingSingleRay_obj(/*opt sys LLT*/ TestSystem00, /*ray origin*/ originTS0_0, /*target point*/ targetPointTS0_1, /*light*/ light, /*accurency*/  0.00001);
	checkRayAiming_E0.push_back(ch00_obj_1.getOnTarget());
	
	bool ch00_obj_manyOptA = checkRayAimingManyRay_obj(/*opt sys LLT*/  TestSystem00, /*ray origin*/ originTS0_0, /*rings*/ 6,/*arms*/ 8,/*light*/ light, /*compare rms*/ 622.192, /*tolerance*/ 0.1, /*accurency*/ 0.00001);
	...
	lightRay_interPoint_onTarget ch00_obj_1_neg05 = checkRayAimingSingleRay_obj(/*opt sys LLT*/ TestSystem00, /*ray origin*/ originTS0_1_neg05, /*target point*/ targetPointTS0_2, /*light*/ light, /*accurency*/  0.00001);
	checkRayAiming_E0.push_back(ch00_obj_1_neg05.getOnTarget());
	
	bool ch00_obj_1_neg05_1 = checkRayAimingManyRay_obj(/*opt sys LLT*/  TestSystem00, /*ray origin*/ originTS0_1_neg05, /*rings*/ 6,/*arms*/ 8,/*light*/ light, /*compare rms*/ 619.310, /*tolerance*/ 0.1, /*accurency*/ 0.00001);
	checkRayAiming_E0.push_back(ch00_obj_1_neg05_1);
	
	// origin at x=-1 , y = 1.5
	VectorStructR3 originTS0_neg1_15 = { -1.0,1.5,0.0 };
	bool ch00_obj_nge1_15 = checkRayAimingManyRay_obj(/*opt sys LLT*/  TestSystem00, /*ray origin*/ originTS0_neg1_15, /*rings*/ 6,/*arms*/ 8,/*light*/ light, /*compare rms*/ 614.482, /*tolerance*/ 0.1, /*accurency*/ 0.00001);
...
bool BenchmarkRayAiming::checkRayAimingE1_obj()
{
	...
	bool ch01_obj_manyOptA = checkRayAimingManyRay_obj(/*opt sys LLT*/  TestSystem01_DG, /*ray origin*/ originTS01_DG_optA, /*rings*/ 6,/*arms*/ 8,/*light*/ light, /*compare rms*/ 42.725, /*tolerance*/ 0.1, /*accurency*/ 0.00001);
	checkRayAiming_E1_DG.push_back(ch01_obj_manyOptA);

	// origin x=2 y=3
	VectorStructR3 originTS01_DG_2_3 = { 2.0,3.0,0.0 };
	bool ch01_obj_2_3 = checkRayAimingManyRay_obj(/*opt sys LLT*/  TestSystem01_DG, /*ray origin*/ originTS01_DG_2_3, /*rings*/ 6,/*arms*/ 8,/*light*/ light, /*compare rms*/ 42.494, /*tolerance*/ 0.1, /*accurency*/ 0.00001);
	checkRayAiming_E1_DG.push_back(ch01_obj_2_3);

	// origin x=-4 y=8
	VectorStructR3 originTS01_DG_neg4_8 = { -4.0,8.0,0.0 };
	bool ch01_obj_neg4_8 = checkRayAimingManyRay_obj(/*opt sys LLT*/  TestSystem01_DG, /*ray origin*/ originTS01_DG_neg4_8, /*rings*/ 6,/*arms*/ 8,/*light*/ light, /*compare rms*/ 40.817, /*tolerance*/ 0.1, /*accurency*/ 0.00001);
	checkRayAiming_E1_DG.push_back(ch01_obj_neg4_8);

	// origin x=3 y=-7
	VectorStructR3 originTS01_DG_3_neg7 = { 3.0,-7.0,0.0 };
	bool ch01_obj_3_nge7 = checkRayAimingManyRay_obj(/*opt sys LLT*/  TestSystem01_DG, /*ray direction*/ originTS01_DG_3_neg7, /*rings*/ 6,/*arms*/ 8,/*light*/ light, /*compare rms*/ 41.450, /*tolerance*/ 0.1, /*accurency*/ 0.00001);
...
bool BenchmarkRayAiming::checkRayAimingE2_obj()
{
...
bool BenchmarkRayAiming::checkRayAimingE0_inf()
{
	...
	bool checkStartP_E0_05_0 = checkStartPointRay(ch00_inf_05_0.getLightRay(), { 0.4300800456,-0.49798195051,13.0 }, 0.001);
	...
	bool checkStartP_E0_05_1 = checkStartPointRay(ch00_inf_05_1.getLightRay(), { 0.0,-1.4601280734,13.0 }, 0.001);
	...
	bool checkStartP_E0_05_2 = checkStartPointRay(ch00_inf_05_2.getLightRay(), { 0.85508961601,0.77763913885,13.0 }, 0.001);
...
bool BenchmarkRayAiming::checkStartPointRay(LightRayStruct lightRay, VectorStructR3 checkStartPoint, real tolerance)
{
...
lightRay_interPoint_onTarget BenchmarkRayAiming::checkRayAimingSingleRay_obj(/*opt sys LLT*/ OpticalSystem_LLT& const optSys_LLT, /*ray origin*/ VectorStructR3& const rayOrigin, /*target point*/ VectorStructR3& const  targetPoint, /*light*/ Light_LLT& const Light, /*accurency*/ real accurency)
{
	RayAiming RayAiming(optSys_LLT);
	RayAiming.setToleranceX_Y(accurency);
	////VectorStructR3 rayDirectionTS00_2 = { 0.0,0.0,1.0 };
...
bool BenchmarkRayAiming::checkRayAimingManyRay_obj(/*opt sys LLT*/ OpticalSystem_LLT& const optSys_LLT, /*ray origin*/ VectorStructR3& const rayOrigin, /*rings*/ unsigned int const ringsAB,/*arms*/ unsigned int const armsAB,/*light*/ Light_LLT& const Light, /*compare rms*/ real checkRMS, real tolerance, real accurancy)
{
	// find position aperture stop in opt sys
	unsigned int posApertureStop = optSys_LLT.getPosApertureStop();
	// get semi height aberture stop
	...
	for (unsigned int i = 0; i < pointsInApStop.size(); i++)
	{
		...
		checker = checkRayAimingSingleRay_obj(/*opt sys LLT*/ optSys_LLT, /*ray origin*/ rayOrigin, /*target point*/ pointsInApStop[i], /*light*/ Light, accurancy);
...
bool BenchmarkRayAiming::checkStartPointRayMany(std::vector<LightRayStruct> lightRay_vec, VectorStructR3 checkStartPoint, real tolerance)
{
