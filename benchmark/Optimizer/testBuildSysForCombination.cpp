...
bool testBuildSysForCombination::checkBuildSysForCom_E1()
{
	...
	SphericalElement Sphere3_E1(/*radius*/ 50.00, /*semi height*/ 4.0, /*point*/{ 0.0,0.0,20.0 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSF8_S1());
...
bool testBuildSysForCombination::checkBuildSysForCom_E4()
{
	...
	// surfaces E4
	ApertureStopElement AperStop0_E4(/* semi height*/1.0, /*point*/{ 0.0,0.0,7.0 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractiv index*/ glasses.getAirZemax());
	SphericalElement Sphere1_E4(/*radius*/ 15.0, /*semi height*/ 5.0, /*point*/{ 0.0,0.0,12.0 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSF13_S1());
	SphericalElement Sphere2_E4(/*radius*/ 20.00, /*semi height*/ 5.0, /*point*/{ 0.0,0.0,17.0 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSF13_S1());
	SphericalElement Sphere3_E4(/*radius*/ 40.00, /*semi height*/ 5.0, /*point*/{ 0.0,0.0,32.0 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getSF13_S1(), /*refractive index B*/glasses.getAirZemax());
	SphericalElement Sphere4_E4(/*radius*/ 90.00, /*semi height*/ 5.0, /*point*/{ 0.0,0.0,37.0 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getSF13_S1(), /*refractive index B*/glasses.getAirZemax());
	SphericalElement Sphere5_E4(/*radius*/ 40.00, /*semi height*/ 5.0, /*point*/{ 0.0,0.0,45.0 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSF13_S1());
	SphericalElement Sphere6_E4(/*radius*/ 15.00, /*semi height*/ 5.0, /*point*/{ 0.0,0.0,50.0 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSF13_S1());
	PlanElement Plan7_E4(/*semi height*/ 10.0, /*point*/{ 0.0,0.0,80.0 },  /*direction*/{ 0.0,0.0,1.0 }, /*refractiv index A*/ glasses.getAirZemax(), /*refractive index B*/ glasses.getAirZemax());
