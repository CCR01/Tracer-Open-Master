...
bool testLocalOpti_BM::checkLocalOpti_BM()
{
	...
	// surfaces E0
	ApertureStopElement AperSto0_E0(/* semi height*/3.0, /*point*/{ 0.0,0.0,30.0 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractiv index*/ glasses.getAirZemax());
	SphericalElement Sphere1_E0(/*radius*/ 20.0, /*semi height*/ 10.0, /*point*/{ 0.0,0.0,35.0 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getBK7_S1());
	SphericalElement Sphere2_E0(/*radius*/ 50.0, /*semi height*/ 10.0, /*point*/{ 0.0,0.0,45.0 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getBK7_S1(), /*refractive index B*/glasses.getSF5_S1());
	SphericalElement Sphere3_E0(/*radius*/ 25.0, /*semi height*/ 10.0, /*point*/{ 0.0,0.0,55.0 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSF5_S1());
	PlanElement Plan4_E0(/*semi height*/ 99.0, /*point*/{ 0.0,0.0,85.0 },  /*direction*/{ 0.0,0.0,1.0 }, /*refractiv index A*/ glasses.getAirZemax(), /*refractive index B*/ glasses.getAirZemax());
	...
	bool checkRMSoptA_E0 = Math::compareTwoNumbers(rms_E0_optA, 354.553, 2);
	...
	bool checkRMSfield2_E0 = Math::compareTwoNumbers(rms_E0_field2, 339.605, 3);
	...
	bool checkRMSfield4_E0 = Math::compareTwoNumbers(rms_E0_field4, 302.609, 2);
