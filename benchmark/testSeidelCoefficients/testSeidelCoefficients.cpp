...
bool testSeidelCoefficients::checkCalculationOfSeidelCoefficients()
{
	...
	SphericalElement Sphere0_E0(/*radius*/ 42.987900, /*semi height*/ 11.5, /*point*/{ 0.0,0.0,10.0 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSK16_S1());
	SphericalElement Sphere1_E0(/*radius*/ 248.077400, /*semi height*/ 11.5, /*point*/{ 0.0,0.0,14.0 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSK16_S1());
	SphericalElement Sphere2_E0(/*radius*/ 38.210335, /*semi height*/ 9.852, /*point*/{ 0.0,0.0,24.51018 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getF4_S1(), /*refractive index B*/glasses.getAirZemax());
	...
	SphericalElement Sphere4_E0(/*radius*/ 43.958940, /*semi height*/ 8.885, /*point*/{ 0.0,0.0,27.01019 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getF4_S1(), /*refractive index B*/glasses.getAirZemax());
	SphericalElement Sphere5_E0(/*radius*/656.663490, /*semi height*/ 14.0, /*point*/{ 0.0,0.0,36.87964 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSK16_S1());
	SphericalElement Sphere6_E0(/*radius*/33.507540, /*semi height*/ 14.0, /*point*/{ 0.0,0.0,41.37964 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSK16_S1());
	PlanElement Plan7_E0(/*semi height*/ 40.0, /*point*/{ 0.0,0.0,127.86607 },  /*direction*/{ 0.0,0.0,1.0 }, /*refractiv index A*/ glasses.getAirZemax(), /*refractive index B*/ glasses.getAirZemax());
	...
	PlanElement Plan0_E1(/*semi height*/ 26.0, /*point*/{ 0.0,0.0,0.0001 },  /*direction*/{ 0.0,0.0,1.0 }, /*refractiv index A*/ glasses.getAirZemax(), /*refractive index B*/ glasses.getSK16_S1());
	PlanElement Plan1_E1(/*semi height*/ 26.0, /*point*/{ 0.0,0.0,3.4701 },  /*direction*/{ 0.0,0.0,-1.0 }, /*refractiv index A*/ glasses.getAirZemax(), /*refractive index B*/ glasses.getSK16_S1());
	SphericalElement Sphere2_E1(/*radius*/ 45.31, /*semi height*/ 26.00, /*point*/{ 0.0,0.0,13.3201 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getLASFN9_S1(), /*refractive index B*/glasses.getAirZemax());
	SphericalElement Sphere3_E1(/*radius*/ 41.94, /*semi height*/ 32.00, /*point*/{ 0.0,0.0,29.9301 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getLASFN9_S1());
	SphericalElement Sphere4_E1(/*radius*/ 195.81, /*semi height*/ 36.00, /*point*/{ 0.0,0.0,30.1701 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getLAF2_S1());
	SphericalElement Sphere5_E1(/*radius*/ 145.34, /*semi height*/ 36.00, /*point*/{ 0.0,0.0,44.7701 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getLAF2_S1());
	SphericalElement Sphere6_E1(/*radius*/112.37, /*semi height*/ 45.00, /*point*/{ 0.0,0.0,45.0101 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSK16_S1());
	...
	SphericalElement Sphere8_E1(/*radius*/95.12, /*semi height*/ 45.00, /*point*/{ 0.0,0.0,79.9001 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSF63_S1());
	SphericalElement Sphere9_E1(/*radius*/349.66, /*semi height*/ 45.00, /*point*/{ 0.0,0.0,80.1401 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSF9_S1());
	SphericalElement Sphere10_E1(/*radius*/58.28, /*semi height*/ 45.00, /*point*/{ 0.0,0.0,84.9501 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getSF9_S1(), /*refractive index B*/glasses.getAirZemax());
	SphericalElement Sphere11_E1(/*radius*/256.57, /*semi height*/ 45.00, /*point*/{ 0.0,0.0,99.1501 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSK16_S1());
	SphericalElement Sphere12_E1(/*radius*/115.95, /*semi height*/ 45.00, /*point*/{ 0.0,0.0,113.5601 }, /*direction*/{ 0.0,0.0,-1.0 }, /*refractive index A*/ glasses.getAirZemax(), /*refractive index B*/glasses.getSK16_S1());
	ApertureStopElement AperStop13_E1(/* semi height*/47.71, /*point*/{ 0.0,0.0,163.5601 }, /*direction*/{ 0.0,0.0,1.0 }, /*refractiv index*/ glasses.getAirZemax());
	PlanElement Plan14_E1(/*semi height*/ 999.0, /*point*/{ 0.0,0.0,168.5601 },  /*direction*/{ 0.0,0.0,1.0 }, /*refractiv index A*/ glasses.getAirZemax(), /*refractive index B*/ glasses.getAirZemax());
	PlanElement Plan15_E1(/*semi height*/ 999.0, /*point*/{ 0.0,0.0,168.5602 },  /*direction*/{ 0.0,0.0,1.0 }, /*refractiv index A*/ glasses.getAirZemax(), /*refractive index B*/ glasses.getAirZemax());
