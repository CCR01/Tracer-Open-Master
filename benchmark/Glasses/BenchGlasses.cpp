...
bool BenchmarkGlasses::checkGlasses()
{
	...
	bool checkAir_S1 = Math::compareTwoNumbers_decimals(1.00027717, resAir_S1, 4);
	...
	bool checkSF15_S1 = Math::compareTwoNumbers_decimals(1.698951, resSF15_S1, 5);
	checkGlasses.push_back(checkSF15_S1);
	//SF66
	real resSF66_S1 = glasses.getSF66_S1().calcRefractiveIndexSnellmeier1(587.6);
	bool checkSF66_S1 = Math::compareTwoNumbers_decimals(1.922859, resSF66_S1, 4);
