...
bool TestImageProcessing::checkImageProcessing()
{
	...
	//Images::showImage_inputUint8("distortionFree", distortionFreeImage);
	...
	//Images::showImage_inputUint8("distortedImage_Chessboard_Big", distortedImage_Chessboard_Big);
	//Images::showImage_inputUint8("distortionFreeImage_Chessboard_Big", distortionFreeImage_Chessboard_Big);

	//// correct distortion
	//cv::Mat distoredImage_Chessboard = Images::loadAnImage_Color("","chessBoardSimulated_S3_640x480.png");
	//cv::Mat distortedElefant = Images::loadAnImage_Color("", "elefantSimulated_S3_640x480.png");
	//cv::Mat undistortedChessboard = ImageProcessing::correctDistortion(distoredImage_Chessboard, distoredImage_Chessboard, 11, 8);
	//cv::Mat undistortedElefant = ImageProcessing::correctDistortion(distortedElefant, distoredImage_Chessboard, 11, 8);
	//Images::showImage_inputUint8("undistortedChessboard", undistortedChessboard);
	//Images::showImage_inputUint8("distorted elefant", distortedElefant);
	//Images::showImage_inputUint8("undistortedElefant", undistortedElefant);
	//Images::saveImage("../", "undistortedElefant_S3", "png", undistortedElefant);
