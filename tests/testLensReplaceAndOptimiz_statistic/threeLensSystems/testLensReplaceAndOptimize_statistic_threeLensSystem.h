...
public:
	...
	std::vector<saveLRaO_GeneticAndDLS_12_statistic> doTheStatisticEvaluation_THREE_lensSystemGeneticAndDLS_12(OpticalSystemElement optSysEle, targetCardinalPointsStruct targetCarPoints, std::string location, std::string example);
	...
	bool testLRaO_stat_THREE_lensSystem_superFct();
