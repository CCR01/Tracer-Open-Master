...
// super fct
bool testLensReplaceAndOptimize_statistic_FIVE_LensSystem::testLRaO_stat_FIVE_lensSystem_superFct()
{
...
std::vector<saveLRaO_GeneticAndDLS_12_statistic> testLensReplaceAndOptimize_statistic_FIVE_LensSystem::doTheStatisticEvaluation_FIVE_lensSystemGeneticAndDLS_12(OpticalSystemElement optSysEle, targetCardinalPointsStruct targetCarPoints, std::string location, std::string example)
{
...
bool testLensReplaceAndOptimize_statistic_FIVE_LensSystem::testLRaO_stat_FIVE_lensSystem_E0(std::string example)
{
	...
	mSaveAllResults_FIVE_LensSystem.push_back(doTheStatisticEvaluation_FIVE_lensSystemGeneticAndDLS_12(optSystemElement, tarCarP, location, example));
