...
void testLensReplaceAndOptimize_statistic_FOUR_LensSystem::exportAllStatisticDataReplace_FOUR_LensesGeneticAndDLS_12()
{
	...
	std::string nameExcel = "data_FOUR_LensSystems";
...
// super fct
bool testLensReplaceAndOptimize_statistic_FOUR_LensSystem::testLRaO_stat_FOUR_lensSystem_superFct()
{
...
std::vector<saveLRaO_GeneticAndDLS_12_statistic> testLensReplaceAndOptimize_statistic_FOUR_LensSystem::doTheStatisticEvaluation_FOUR_lensSystemGeneticAndDLS_12(OpticalSystemElement optSysEle, targetCardinalPointsStruct targetCarPoints, std::string location, std::string example)
{
...
bool testLensReplaceAndOptimize_statistic_FOUR_LensSystem::testLRaO_stat_FOUR_lensSystem_E0(std::string example)
{
	...
	mSaveAllResults_FOUR_LensSystem.push_back(doTheStatisticEvaluation_FOUR_lensSystemGeneticAndDLS_12(optSystemElement, tarCarP, location, example));
