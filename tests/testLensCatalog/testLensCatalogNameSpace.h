...
namespace testLensCata
{
	...
	bool testOneLensThreeSurfaces_startInf_0deg(/*size aperture stop*/ real sizeAperStop, real wavelength, OpticalSystemElement optSys_HLT, VectorStructR3 positionImageSurface, real rms, real tolerance);
	bool testOneLensFourSurfaces_startInf_0deg(/*size aperture stop*/ real sizeAperStop, real wavelength, OpticalSystemElement optSys_HLT, VectorStructR3 positionImageSurface, real rms, real tolerance);
}